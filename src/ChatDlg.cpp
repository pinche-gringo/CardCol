...
//-----------------------------------------------------------------------------
ChatDlg::ChatDlg()
    : XGP::XDialog(CANCEL), txtMsg(Gtk::make_managed<Gtk::Entry>()), tvMsgs(Gtk::make_managed<Gtk::TextView>()),
    ...
    scrlMsgs.set_hexpand();
    scrlMsgs.set_vexpand();
    scrlMsgs.set_margin(5);
...
/// Destructor
//-----------------------------------------------------------------------------
ChatDlg::~ChatDlg() { TRACE9("ChatDlg::~ChatDlg()"); }
