<!-- -*-HTML-*- -->
<!--
  Copyright (C) 2006 - 2009 Markus Schwab (g17m0@users.sourceforge.net)
...
<html>
  <head>
    ...
    <meta name="DC.Rights" content="Copyright (C) 2006 - 2009; distributed under the GNU Free Documentation License">
  </head>
